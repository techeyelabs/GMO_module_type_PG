	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			<tbody>
				...
				<tr>
					...
					<td><input name="ClientField1" type="text" maxlength="100" tabindex="20" /> </td>
				</tr>
				<tr>
					<th scope="row">加盟店自由項目２(ClientField2)</th>
					<td><input name="ClientField2" type="text" maxlength="100" tabindex="21" /> </td>
				</tr>
				<tr>
					<th scope="row">加盟店自由項目３(ClientField3)</th>
					<td><input name="ClientField3" type="text" maxlength="100" tabindex="22" /> </td>
				</tr>
				<tr>
					<th scope="row">利用明細に記載される文言(DisplayInfo)</th>
					<td><input name="DisplayInfo" type="text" maxlength="100" tabindex="23" /> </td>
				</tr>
			</tbody>
		</table>
		<table>
			<tbody>
				<tr>
					...
					<td>
						<select name="PayMethod" tabindex="24">
				...
				<tr>
					...
					<td><input name="PayTimes" type="text" maxlength="3" class="num" size="5" tabindex="25" /></td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			...
			<tr>
				...
				<td><input name="CardNo" type="text" maxlength="16" size="20" tabindex="26"/></td>
			</tr>
			<tr>
				<th scope="row">カード有効期限YYMM(Expire)</th>
				<td><input name="Expire" type="text" maxlength="4" size="5" tabindex="27" /></td>
			</tr>
			<tr>
				<th scope="row">セキュリティコード(SecurityCode)</th>
				<td><input name="SecurityCode" type="text" maxlength="4" size="5" tabindex="28" /></td>
			</tr>
			</tbody>
		</table>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><input name="MemberID" type="text" maxlength="60" size="30" tabindex="29" /></td>
				</tr>
				<tr>
					<th scope="row">登録カード連番(CardSeq)</th>
					<td><input name="CardSeq" type="text" maxlength="1" class="num" size="5" tabindex="30" /></td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			...
			<tr>
				...
				<td>
					<select name="TokenType" tabindex="31">
			...
			<tr>
				...
				<td><input name="Token" type="text" maxlength="512" size="50" tabindex="32"/></td>
			</tr>
			</tbody>
		</table>
		...
		<table>
			<caption>3DS2.0を利用する場合、この欄を入力</caption>
				<tr>
					...
					<td><input name="Tds2ChAccChange" type="text" maxlength="8" size="10" tabindex="33" /> </td>
				</tr>
				<tr>
					<th scope="row">カード会員作成日YYYYMMDD(Tds2ChAccDate)</th>
					<td><input name="Tds2ChAccDate" type="text" maxlength="8" size="10" tabindex="34" /> </td>
				</tr>
				<tr>
					<th scope="row">カード会員パスワード変更日YYYYMMDD(Tds2ChAccPwChange)</th>
					<td><input name="Tds2ChAccPwChange" type="text" maxlength="8" size="10" tabindex="35" /> </td>
				</tr>
				<tr>
					<th scope="row">過去6ヶ月間の購入回数(Tds2NbPurchaseAccount)</th>
					<td><input name="Tds2NbPurchaseAccount" type="text" maxlength="4" size="5" tabindex="36" class="num" /> </td>
				</tr>
				<tr>
					<th scope="row">カード登録日YYYYMMDD(Tds2PaymentAccAge)</th>
					<td><input name="Tds2PaymentAccAge" type="text" maxlength="8" size="10" tabindex="37" /> </td>
				</tr>
				<tr>
					<th scope="row">過去24時間のカード追加の試行回数(Tds2ProvisionAttemptsDay)</th>
					<td><input name="Tds2ProvisionAttemptsDay" type="text" maxlength="8" size="10" tabindex="38" class="num" /> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の初回使用日YYYYMMDD(Tds2ShipAddressUsage)</th>
					<td><input name="Tds2ShipAddressUsage" type="text" maxlength="8" size="10" tabindex="39"/> </td>
				</tr>
				<tr>
					<th scope="row">3DS2.0非対応時の対応種別(Tds2ShipNameInd)</th>
					<td>
						<select name="Tds2ShipNameInd" tabindex="40">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td>
						<select name="Tds2SuspiciousAccActivity" tabindex="41">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td><input name="Tds2TxnActivityDay" type="text" maxlength="3" size="5" tabindex="42"  class="num"/> </td>
				</tr>
				<tr>
					<th scope="row">前年の取引回数(Tds2TxnActivityYear)</th>
					<td><input name="Tds2TxnActivityYear" type="text" maxlength="3" size="5" tabindex="43"  class="num"/> </td>
				</tr>
				<tr>
					<th scope="row">ログイン証跡(Tds2ThreeDSReqAuthData)</th>
					<td><input name="Tds2ThreeDSReqAuthData" type="text" maxlength="2048" tabindex="44"/> </td>
				</tr>
				<tr>
					<th scope="row">ログイン方法(Tds2ThreeDSReqAuthMethod)</th>
					<td>
						<select name="Tds2ThreeDSReqAuthMethod" tabindex="45">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td><input name="Tds2ThreeDSReqAuthTimestamp" type="text" maxlength="12" size="10" tabindex="46"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所と配送先住所の一致/不一致(Tds2AddrMatch)</th>
					<td>
						<select name="Tds2AddrMatch" tabindex="47">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td><input name="Tds2BillAddrCity" type="text" maxlength="50" tabindex="48"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所の国番号(Tds2BillAddrCountry)</th>
					<td><input name="Tds2BillAddrCountry" type="text" maxlength="3" size="5" tabindex="49"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所の区域部分の１行目(Tds2BillAddrLine1)</th>
					<td><input name="Tds2BillAddrLine1" type="text" maxlength="50" tabindex="50"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所の区域部分の２行目(Tds2BillAddrLine2)</th>
					<td><input name="Tds2BillAddrLine2" type="text" maxlength="50" tabindex="51"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所の区域部分の３行目(Tds2BillAddrLine3)</th>
					<td><input name="Tds2BillAddrLine3" type="text" maxlength="50" tabindex="52"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所の郵便番号(Tds2BillAddrPostCode)</th>
					<td><input name="Tds2BillAddrPostCode" type="text" maxlength="16" tabindex="53"/> </td>
				</tr>
				<tr>
					<th scope="row">請求先住所の州または都道府県番号(Tds2BillAddrState)</th>
					<td><input name="Tds2BillAddrState" type="text" maxlength="3" size="5" tabindex="54"/> </td>
				</tr>
				<tr>
					<th scope="row">カード会員のメールアドレス(Tds2Email)</th>
					<td><input name="Tds2Email" type="text" maxlength="254" tabindex="55"/> </td>
				</tr>
				<tr>
					<th scope="row">自宅電話の国コード(Tds2HomePhoneCC)</th>
					<td><input name="Tds2HomePhoneCC" type="text" maxlength="3" size="5" tabindex="56"/> </td>
				</tr>
				<tr>
					<th scope="row">自宅電話番号(Tds2HomePhoneSubscriber)</th>
					<td><input name="Tds2HomePhoneSubscriber" type="text" maxlength="15" size="10" tabindex="57"/> </td>
				</tr>
				<tr>
					<th scope="row">携帯電話の国コード(Tds2MobilePhoneCC)</th>
					<td><input name="Tds2MobilePhoneCC" type="text" maxlength="3" size="5" tabindex="58"/> </td>
				</tr>
				<tr>
					<th scope="row">携帯電話番号(Tds2MobilePhoneSubscriber)</th>
					<td><input name="Tds2MobilePhoneSubscriber" type="text" maxlength="15" size="52" tabindex="59"/> </td>
				</tr>
				<tr>
					<th scope="row">職場電話の国コード(Tds2WorkPhoneCC)</th>
					<td><input name="Tds2WorkPhoneCC" type="text" maxlength="3" size="5" tabindex="60"/> </td>
				</tr>
				<tr>
					<th scope="row">職場電話番号(Tds2WorkPhoneSubscriber)</th>
					<td><input name="Tds2WorkPhoneSubscriber" type="text" maxlength="15" size="10" tabindex="61"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の都市(Tds2ShipAddrCity)</th>
					<td><input name="Tds2ShipAddrCity" type="text" maxlength="50" tabindex="62"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の国番号(Tds2ShipAddrCountry)</th>
					<td><input name="Tds2ShipAddrCountry" type="text" maxlength="3" size="5" tabindex="63"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の区域部分の１行目(Tds2ShipAddrLine1)</th>
					<td><input name="Tds2ShipAddrLine1" type="text" maxlength="50" tabindex="64"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の区域部分の２行目(Tds2ShipAddrLine2)</th>
					<td><input name="Tds2ShipAddrLine2" type="text" maxlength="50" tabindex="65"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の区域部分の３行目(Tds2ShipAddrLine3)</th>
					<td><input name="Tds2ShipAddrLine3" type="text" maxlength="50" tabindex="66"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の郵便番号(Tds2ShipAddrPostCode)</th>
					<td><input name="Tds2ShipAddrPostCode" type="text" maxlength="16" tabindex="67"/> </td>
				</tr>
				<tr>
					<th scope="row">配送先住所の州または都道府県番号(Tds2ShipAddrState)</th>
					<td><input name="Tds2ShipAddrState" type="text" maxlength="3" size="5" tabindex="68"/> </td>
				</tr>
				<tr>
					<th scope="row">納品先電子メールアドレス(Tds2DeliveryEmailAddress)</th>
					<td><input name="Tds2DeliveryEmailAddress" type="text" maxlength="254" tabindex="69"/> </td>
				</tr>
				<tr>
					<th scope="row">商品納品時間枠(Tds2DeliveryTimeframe)</th>
					<td>
						<select name="Tds2DeliveryTimeframe" tabindex="70">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td><input name="Tds2GiftCardAmount" type="text" maxlength="15" size="10" tabindex="71"/> </td>
				</tr>
				<tr>
					<th scope="row">購入されたプリペイドカードまたはギフトカード の総数(Tds2GiftCardCount)</th>
					<td><input name="Tds2GiftCardCount" type="text" maxlength="2" size="5" tabindex="72"/> </td>
				</tr>
				<tr>
					<th scope="row">購入されたプリペイドカードまたはギフトカードの通貨コード(Tds2GiftCardCurr)</th>
					<td><input name="Tds2GiftCardCurr" type="text" maxlength="3" size="5" tabindex="73"/> </td>
				</tr>
				<tr>
					<th scope="row">商品の発売予定日YYYYMMDD(Tds2PreOrderDate)</th>
					<td><input name="Tds2PreOrderDate" type="text" maxlength="8" size="10" tabindex="74"/> </td>
				</tr>
				<tr>
					<th scope="row">商品の販売時期情報(Tds2PreOrderPurchaseInd)</th>
					<td>
						<select name="Tds2PreOrderPurchaseInd" tabindex="75">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td>
						<select name="Tds2ReorderItemsInd" tabindex="76">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td>
						<select name="Tds2ShipInd" tabindex="77">
							<option value="">無指定</option>
				...
				<tr>
					...
					<td><input name="Tds2RecurringExpiry" type="text" maxlength="8" size="10" tabindex="78"/> </td>
				</tr>
				<tr>
					<th scope="row">継続課金の課金最小間隔日数(Tds2RecurringFrequency)</th>
					<td><input name="Tds2RecurringFrequency" type="text" maxlength="4" size="5" tabindex="79"/> </td>
				</tr>
				<tr>
					<th scope="row">加盟店戻りURL(RetUrl)</th>
					<td><input name="RetUrl" type="text" maxlength="256" tabindex="80"/> </td>
				</tr>
		</table>
		<input name="submit" type="submit" value="実行"  tabindex="81" />
	</form>
	<?php
		}else{//送信結果の表示です
	?>

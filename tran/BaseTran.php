...
require_once 'common/ParamParser.php';
require_once 'common/IgnoreCaseMap.php';
require_once 'common/GPayException.php';
require_once 'common/ConnectUrlMap.php';
...
class BaseTran {
	...
	protected function sendData(&$urlConnect, $params) {
		...
		// if(($html = curl_exec($urlConnect)) == false)
		// 	{
		// 		echo 'Curl error: ' . curl_error($urlConnect);
		// 		die('111');
		// 	}
		// 	curl_close($$urlConnect);
		// 	echo $html;
		...
		// $retData  = "AccessID=07937c7c6fc61226fd2f11d3d1269faa&AccessPass=2652553c2b1071238bd9d1defe37a99f";
		return $retData;
	}
